<?php
namespace Mehler\Simplenews\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
...
/**
 * Test case for class Mehler\Simplenews\Controller\NewsController.
 *
...
class NewsControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \Mehler\Simplenews\Controller\NewsController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('Mehler\\Simplenews\\Controller\\NewsController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllNewssFromRepositoryAndAssignsThemToView() {
		...
		$newsRepository = $this->getMock('Mehler\\Simplenews\\Domain\\Repository\\NewsRepository', array('findAll'), array(), '', FALSE);
